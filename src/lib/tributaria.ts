...
export const LINHAS: Record<string, LinhaCampo[]> = {
  ...
  impostos: [
    ...
    { key: "icmsEstoque", label: "TOTAL ICMS:", total: { debito: "icmsDebito", credito: "icmsCredito" } },
    { key: "icmsTTDDebito", label: "ICMS TTD — Débito", header: "ICMS TTD (guia própria)" },
    { key: "icmsTTDCredito", label: "ICMS TTD — Crédito" },
    { key: "icmsTTDEstoque", label: "TOTAL ICMS TTD:", total: { debito: "icmsTTDDebito", credito: "icmsTTDCredito" } },
    ...
    { key: "pisEstoque", label: "TOTAL PIS:", total: { debito: "pisDebito", credito: "pisCredito" } },
    { key: "cofinsDebito", label: "COFINS — Débito", header: "COFINS (não-cumulativo — só Lucro Real)" },
    { key: "cofinsCredito", label: "COFINS — Crédito" },
    { key: "cofinsEstoque", label: "TOTAL COFINS:", total: { debito: "cofinsDebito", credito: "cofinsCredito" } },
  ],
  lalur: [
